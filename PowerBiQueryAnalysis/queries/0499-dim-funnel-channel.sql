-- Power BI query shape 499 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            3
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             101,896,527
-- Rows returned         2,898,387
-- Avg duration          64,925 ms
...
WITH CTE AS (
  ...
  /* case when ctea.hmcrequestid is not null then 1 else 0 end SLRl, CTE.* */
  SELECT
    CTE.*,
    CASE
      WHEN affiliateID = 87
