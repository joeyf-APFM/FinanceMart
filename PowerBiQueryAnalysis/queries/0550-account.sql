-- Power BI query shape 550 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            2
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             13,822,955
-- Rows returned         2
-- Avg duration          7,965 ms
...
WITH CTE AS (
  ...
  /* o.is_won = true */
  WHERE
    o.close_date >= '2025-10-01' AND a.hmc_cart_provider_id_c = 32933
), CTEA1 AS (
  SELECT
    CTE.ProviderID,
  ...
  WHERE
    ...
    AND /* and p.providerorganizationid is null */ cph.date >= '2025-12-01'
  GROUP BY
    1,
    2,
    3,
