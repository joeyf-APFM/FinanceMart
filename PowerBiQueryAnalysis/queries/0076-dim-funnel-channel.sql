-- Power BI query shape 76 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            1,150
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             61,733,057,552
-- Rows returned         5,797,592
-- Avg duration          10,209 ms
...
WITH CTE /* where hmcr.affiliateid in (140,141) */ AS (
  SELECT
    hmcr.HMCRequestID,
    hmcr.HMCProspectID,
  ...
  WHERE
    ...
    AND hmcr.affiliateid IN (140, 141)
), CTEB AS (
  SELECT
    HMCRequestID,
    HMCProspectID,
