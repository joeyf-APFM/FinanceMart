-- Power BI query shape 186 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            265
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             110,275,839
-- Rows returned         3,267,450
-- Avg duration          5,547 ms
