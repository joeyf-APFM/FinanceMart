-- Power BI query shape 51 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            1,837
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             12,747,003,868
-- Rows returned         8,413,648,392
-- Avg duration          13,460 ms
-- Power BI datasets     36a8e73a-5aae-46e5-a621-b847af424af7, 75a0183c-2c90-4d23-9c69-cdb19108448e
-- Tables                prod_homecare_insite_directory.affiliate, prod_homecare_insite_directory.hmcrequest, prod_homecare_insite_directory.hmcscreeningresult
--
...
WITH CTE AS (
  ...
  LEFT JOIN (
    ...
    WHERE
      outcomeid IN (12, 13, 14, 16, 17, 18, 20)
  ) AS sr
...
SELECT DISTINCT
  *,
  CASE
    ...
    THEN 'NB:NAT:Hospice Care:T1:Broad'
    ...
    THEN 'NB:NAT:Respite Care:T1:Exact'
