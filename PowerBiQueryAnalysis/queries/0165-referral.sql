-- Power BI query shape 165 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            297
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             1,217,541,560
-- Rows returned         140,128
-- Avg duration          2,954 ms
...
SELECT DISTINCT
  ref.providerid,
  CTE.orderid,
  CONCAT(ref.providerid, '-', CTE.orderid) AS ProviderOrders,
  CASE
