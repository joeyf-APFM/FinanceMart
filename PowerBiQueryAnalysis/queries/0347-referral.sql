-- Power BI query shape 347 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            18
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             20,672,983
-- Rows returned         18,000
-- Avg duration          259 ms
...
WITH CTE AS (
  ...
  WHERE
    p.providerorganizationid = 117 AND hmcr.createdate >= '2025'
), CTEA AS (
  SELECT
    CTE.hmcrequestid,
    Ref.referralid
