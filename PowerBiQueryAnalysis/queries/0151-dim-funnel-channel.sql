-- Power BI query shape 151 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            340
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             22,568,804,273
-- Rows returned         1,423,646,725
-- Avg duration          196,550 ms
-- Power BI datasets     2cceff05-ca68-44c0-8f76-545dd698db36, c510df23-2b0d-4820-90d4-7aa0d70d29f0
...
LEFT JOIN prod_homecare_insite_directory.hmcprospectphonenumber AS ppn
  ON hmcp.hmcprospectid = ppn.hmcprospectid
LEFT JOIN (
  SELECT
    hmcrequestid,
    outcomeid,
  ...
  ON sr.hmcrequestid = hmcr.hmcrequestid AND rn = 1
