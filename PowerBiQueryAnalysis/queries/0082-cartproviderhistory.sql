-- Power BI query shape 82 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            1,003
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             16,192,923,789
-- Rows returned         274,873,151
-- Avg duration          7,828 ms
...
WITH CTE AS (
  ...
  JOIN CTE
    ON CTE.accountid = hcc.accountid
