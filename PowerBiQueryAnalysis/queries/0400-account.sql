-- Power BI query shape 400 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            6
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             25,299,738
-- Rows returned         12
-- Avg duration          3,372 ms
...
WITH CTE AS (
  ...
  /* o.is_won = true */
  WHERE
    o.close_date >= '2025-10-01' AND a.hmc_cart_provider_id_c = 44429
), CTEC AS (
  SELECT
    CTE.ProviderID,
