-- Power BI query shape 486 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            3
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             65,039,625
-- Rows returned         569,949
-- Avg duration          11,254 ms
...
SELECT
  *,
  ...
  DATE_FORMAT(chargecreatedate, 'MM-yyyy') AS CreateMonth,
  CASE
