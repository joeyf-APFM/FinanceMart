-- Power BI query shape 452 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            4
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             169,697,288
-- Rows returned         42,427,322
-- Avg duration          46,421 ms
...
WHERE
  TO_DATE(detaildate, 'yyyy/MM/dd') >= '2024'
