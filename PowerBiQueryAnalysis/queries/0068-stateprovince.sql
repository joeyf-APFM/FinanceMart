-- Power BI query shape 68 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            1,473
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             22,880
-- Rows returned         95,745
-- Avg duration          369 ms
...
-- Tables                prod_homecare_actransactional_geo.stateprovince
--
...
SELECT
  *
FROM prod_homecare_actransactional_geo.stateprovince
