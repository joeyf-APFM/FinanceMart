-- Power BI query shape 413 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            5
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             181,994,496
-- Rows returned         3,177,858
-- Avg duration          15,202 ms
...
WITH CTE AS (
  ...
  LEFT JOIN (
    ...
    WHERE
      ...
      AND sr.createdate >= '2023-11-01' /* and sr.hmcprospectid = 3695914 */
  ) AS sr
