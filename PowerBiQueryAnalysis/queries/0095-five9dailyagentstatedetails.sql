-- Power BI query shape 95 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            906
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             19,145,944,210
-- Rows returned         70,094,677,390
-- Avg duration          57,363 ms
