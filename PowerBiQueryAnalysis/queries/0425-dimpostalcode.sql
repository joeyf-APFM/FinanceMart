-- Power BI query shape 425 of 663, from workspace_jf.landscape.qh.
...
SELECT
  CTE2.*
  EXCEPT (hmcprospectid, postalcode, affiliatename, rn, source, campaign1, campaignid),
  CASE
    WHEN AdjChannel = 'SEM'
    AND CampaignID IN (
      21152744542,
