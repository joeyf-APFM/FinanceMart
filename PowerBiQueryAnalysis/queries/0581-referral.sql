-- Power BI query shape 581 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            2
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             10,616,838
-- Rows returned         135,330
-- Avg duration          1,639 ms
-- Power BI datasets     none recorded
-- Tables                prod_homecare_actransactional_homecare.referral, prod_homecare_insite_directory.hmclead, prod_homecare_insite_directory.hmcrequest, reporting.dim_geography_zip_dma
--
...
WITH CTE AS (
  ...
  WHERE
    hmcr.createdate >= '2024' AND hmcr.requeststatusid = 2 AND ref.orderid <> 2774
), CTE1 AS (
  SELECT
    DMA,
    MonthYearID,
