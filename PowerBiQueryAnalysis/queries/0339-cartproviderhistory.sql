-- Power BI query shape 339 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            22
-- Distinct texts        4 (same query, different literals or projection)
-- Rows read             31,667,232
-- Rows returned         1,038,298
-- Avg duration          538 ms
...
LEFT JOIN main.prod_homecare_actransactional_organization.providerorganization AS po
  ON po.providerorganizationid = po.providerorganizationid
