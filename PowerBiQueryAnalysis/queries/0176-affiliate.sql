-- Power BI query shape 176 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            281
-- Distinct texts        4 (same query, different literals or projection)
-- Rows read             700,750,779
-- Rows returned         708,384,859
-- Avg duration          7,422 ms
