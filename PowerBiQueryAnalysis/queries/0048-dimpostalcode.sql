-- Power BI query shape 48 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            1,850
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             8,171,638,132
-- Rows returned         1,269,995,137
-- Avg duration          7,551 ms
-- Power BI datasets     36a8e73a-5aae-46e5-a621-b847af424af7, 75a0183c-2c90-4d23-9c69-cdb19108448e, da74b405-09e2-41e3-bed6-583fc3c4acae, eda315a6-a542-4102-b6ce-3551c75b1bdd
...
WITH CTE AS (
  SELECT DISTINCT
    ...
    CASE
      ...
      ELSE 'Not DJ'
    END AS DJStep,
    CASE WHEN NOT hmcr.djtypeid IS NULL THEN 'Offered DJ' ELSE 'Not Offered DJ' END AS DJ,
