-- Power BI query shape 475 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            3
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             27,485,632
-- Rows returned         2,957,116
-- Avg duration          2,249 ms
...
WHERE
  ...
  AND NOT p.providerorganizationid IS NULL
ORDER BY
  ReferredOn DESC
