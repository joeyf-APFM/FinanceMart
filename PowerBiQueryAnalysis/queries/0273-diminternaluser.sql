-- Power BI query shape 273 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            103
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             1,651,906,382
-- Rows returned         753,077
-- Avg duration          6,574 ms
...
WITH CTE AS (
  ...
  WHERE
    ...
    AND CreatedOn >= DATE_ADD(MONTH, -6, CURRENT_TIMESTAMP())
)
SELECT
  *
FROM CTE
