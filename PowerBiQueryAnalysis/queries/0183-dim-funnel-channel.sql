-- Power BI query shape 183 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            268
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             6,391,784,233
-- Rows returned         1,209,242,782
-- Avg duration          16,001 ms
