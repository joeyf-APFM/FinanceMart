-- Power BI query shape 487 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            3
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             96,075,873
-- Rows returned         9,746,764
-- Avg duration          8,449 ms
...
WITH CTE AS (
  ...
  SELECT
    ...
    LSTF,
    RL,
    CAST(campaign1 AS INT) AS CampaignID
  FROM CTE2
)
SELECT DISTINCT
  *,
