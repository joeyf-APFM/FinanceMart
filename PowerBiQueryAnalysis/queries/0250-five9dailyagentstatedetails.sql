-- Power BI query shape 250 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            142
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             2,837,854,950
-- Rows returned         2,836,182,967
-- Avg duration          123,587 ms
...
WHERE
  TO_DATE(detaildate, 'yyyy/MM/dd') >= DATE_ADD(YEAR, -1, DATE_TRUNC('MONTH', CURRENT_TIMESTAMP()))
