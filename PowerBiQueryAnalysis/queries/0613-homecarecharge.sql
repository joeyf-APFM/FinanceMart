-- Power BI query shape 613 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            2
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             27,556,726
-- Rows returned         2,465,892
-- Avg duration          12,913 ms
...
SELECT DISTINCT
  ...
  hcc.Amount,
  CASE WHEN p.providerorganizationid IS NULL THEN 'Indpendent' ELSE 'Franchise' END AS Org,
  CASE
