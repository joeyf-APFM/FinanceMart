-- Power BI query shape 597 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            2
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             11,717,110
-- Rows returned         10,647
-- Avg duration          32,076 ms
...
SELECT
  ...
  obst.name AS OrderSubStatus,
  o.orderstatusreasonnote,
