-- Power BI query shape 561 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            2
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             641,925
-- Rows returned         60,942
-- Avg duration          3,102 ms
...
WITH CTEA AS (
  ...
  WHERE
    NOT p.providerorganizationid IS NULL
    AND a.paymentmethodtypeid = 3
