-- Power BI query shape 372 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            8
-- Distinct texts        4 (same query, different literals or projection)
-- Rows read             41,357,572
-- Rows returned         1,510,784
...
WITH CTE /* and a.hmc_cart_provider_id_c = 49349 */ AS (
  SELECT
