-- Power BI query shape 502 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            3
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             45,428,045
-- Rows returned         2,892
-- Avg duration          10,453 ms
...
SELECT DISTINCT
  ...
  DATEDIFF(DAY, firstactivedate, CAST(CURRENT_TIMESTAMP() AS DATE)) AS ProviderOrder_Age
FROM CTE3
LEFT JOIN CTED
