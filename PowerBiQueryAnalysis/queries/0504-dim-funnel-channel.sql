-- Power BI query shape 504 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            3
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             101,899,038
-- Rows returned         3,262,857
-- Avg duration          12,409 ms
