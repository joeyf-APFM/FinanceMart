-- Power BI query shape 136 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            387
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             8,029,769,265
-- Rows returned         1,030,161,725
-- Avg duration          13,015 ms
...
WITH CTE AS (
  ...
  WHERE
    f9.Timestamp >= DATE_ADD(MONTH, -5, CURRENT_DATE)
)
SELECT
  *,
