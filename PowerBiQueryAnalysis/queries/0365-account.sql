-- Power BI query shape 365 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            10
-- Distinct texts        4 (same query, different literals or projection)
-- Rows read             71,767,782
-- Rows returned         101,043
-- Avg duration          1,644 ms
...
WITH CTE /* and a.hmc_cart_provider_id_c = 50186 */ AS (
  SELECT
