-- Power BI query shape 647 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            1
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             14,087,593
-- Rows returned         1
-- Avg duration          5,127 ms
...
WITH CTE AS (
  ...
  /* o.is_won = true */
  WHERE
    o.close_date >= '2025-10-01' AND a.hmc_cart_provider_id_c = 49349
), CTEC AS (
  SELECT
    CTE.ProviderID,
