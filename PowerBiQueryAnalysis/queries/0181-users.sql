-- Power BI query shape 181 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            272
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             44,604,985
-- Rows returned         240,404
-- Avg duration          2,129 ms
...
WHERE
  rn.ReferralProcessStageID = 11 AND NOT ref.ReferralID IS NULL
