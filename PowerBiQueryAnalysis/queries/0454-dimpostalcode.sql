-- Power BI query shape 454 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            4
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             145,589,800
-- Rows returned         3,117,152
-- Avg duration          10,978 ms
  ...
  LEFT JOIN (
    SELECT
      ...
      CASE
        ...
        THEN 1
        WHEN sr.userid = 1702946 AND sr.createdate >= ref.referredon
        THEN 1
        ELSE 0
