-- Power BI query shape 289 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            77
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             1,728,356,593
-- Rows returned         7,164,705
-- Avg duration          22,537 ms
-- Power BI datasets     none recorded
-- Tables                prod.dim_funnel_channel, prod.funnel_lead, prod_homecare_insite_directory.affiliate, prod_homecare_insite_directory.hmcrequest, prod_homecare_insite_directory.hmcscreeningresult, reporting.dim_geography_zip_dma
--
...
WITH CTE AS (
  ...
  WHERE
    ...
    AND dma IN ('Boston', 'Houston', 'Atlanta')
), CTE2 AS (
  SELECT
    HMCRequestID,
    HMCProspectID,
