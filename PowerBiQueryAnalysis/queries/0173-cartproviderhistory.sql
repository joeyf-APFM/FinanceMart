-- Power BI query shape 173 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            284
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             3,805,547,859
-- Rows returned         5,380,415
-- Avg duration          4,179 ms
...
WHERE
  CurrentOrderStatus = 'Cancelled' AND cte.orderid <> 3192
