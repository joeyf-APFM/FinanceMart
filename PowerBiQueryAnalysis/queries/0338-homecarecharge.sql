-- Power BI query shape 338 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            22
-- Distinct texts        4 (same query, different literals or projection)
-- Rows read             47,859,727
-- Rows returned         1,073,646
-- Avg duration          704 ms
