-- Power BI query shape 426 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            5
-- Distinct texts        4 (same query, different literals or projection)
-- Rows read             71,552,419
-- Rows returned         2,634,553
-- Avg duration          1,485 ms
...
WHERE
  hmcr.createdate >= '2023' AND hmcr.createdate < '2024'
