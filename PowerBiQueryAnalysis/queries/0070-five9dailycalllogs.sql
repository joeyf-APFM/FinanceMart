-- Power BI query shape 70 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            1,403
-- Distinct texts        5 (same query, different literals or projection)
-- Rows read             24,500,518,364
-- Rows returned         922,169,853
-- Avg duration          4,893 ms
...
FROM CTE1
WHERE
  Timestamp >= '2024-01-01' AND AgentGroup = 'AC HCAM'
