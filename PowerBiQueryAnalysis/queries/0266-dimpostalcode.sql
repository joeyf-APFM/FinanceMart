-- Power BI query shape 266 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            105
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             2,160,497,952
-- Rows returned         84,182,172
-- Avg duration          25,685 ms
...
WITH CTE AS (
  ...
  WHERE
    ...
    AND hmcr.createdate >= DATE_ADD(MONTH, -7, CURRENT_TIMESTAMP())
