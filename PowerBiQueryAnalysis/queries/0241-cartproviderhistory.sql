-- Power BI query shape 241 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            210
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             2,773,366,124
-- Rows returned         3,551,286
-- Avg duration          2,906 ms
...
WITH CTE AS (
  ...
  SELECT
    ...
    CASE
      WHEN p.providerorganizationid = 123 AND cte.orderid <> 31795
      THEN 'Active'
      WHEN cte2.orderstatus IS NULL
      THEN ost.name
      ELSE cte2.orderstatus
