-- Power BI query shape 158 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            304
-- Distinct texts        3 (same query, different literals or projection)
-- Rows read             290,266,852
-- Rows returned         131,524
-- Avg duration          3,785 ms
