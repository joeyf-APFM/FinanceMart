-- Power BI query shape 6 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            4,125
-- Distinct texts        1 (same query, different literals or projection)
-- Rows read             61,269,440,363
-- Rows returned         11,568,616,514
-- Avg duration          18,146 ms
-- Power BI datasets     e9d48e9c-bb12-4860-b411-434978fd49fe, fe02549c-24f9-4a63-88e9-89efbaf400ed
