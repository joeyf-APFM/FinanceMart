-- Power BI query shape 111 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            588
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             1,853,197,505
-- Rows returned         481,590
-- Avg duration          8,344 ms
...
LEFT JOIN (
  ...
  WHERE
    referralstatustypeid = 5 AND BillingTypeID = 3 AND ReferredOn >= '2023-01-01'
) AS r
...
WHERE
  rn.ReferralProcessStageID = 11 AND NOT r.ReferralID IS NULL
