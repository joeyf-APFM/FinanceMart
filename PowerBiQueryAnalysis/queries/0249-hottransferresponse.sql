-- Power BI query shape 249 of 663, from workspace_jf.landscape.qh.
-- Not a schema probe: this shape reads data and returns rows.
--
-- Executions            143
-- Distinct texts        2 (same query, different literals or projection)
-- Rows read             1,197,753,247
-- Rows returned         7,509,814
-- Avg duration          3,367 ms
...
WITH CTE AS (
  ...
  WHERE
    HotTransferredOn >= DATE_ADD(YEAR, -1, DATE_TRUNC('MONTH', CURRENT_TIMESTAMP()))
)
SELECT
  hmcrequestid,
